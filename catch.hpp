...
namespace Catch {
    ...
    public: // substrings and searches
        auto substr(size_type start, size_type size) const
...
struct NameAndTags {
    NameAndTags(StringRef name_ = "", StringRef tags_ = "")
